...
class MessageSchema(Schema):
    ...
    def get_alerts(self, message):
        ...
        externalURL = message.get('externalURL', None)
        ...
        for alert in message['alerts']:
            ...
            if runbook_url == '':
                runbook_url = alert['annotations'].get('investigate_link', '')
            ...
            alert = PrometheusAlert(name, status, severity, summary, instance, description, fingerprint, runbook_url, generatorURL, externalURL,  extra_labels, extra_annotations)
...
class PrometheusAlert:
    def __init__(self, name, status, severity, summary, instance, description, fingerprint, runbook_url, generatorURL, externalURL = None, extra_labels=None, extra_annotations=None,):
        self.name = name
        self.status = status
